...
modified: '2019-10-28T06:07:09.513Z'
---
...
![Suffix Trie of abaaba$ Suffix T aba](@attachment/7bb5a489-7b28-456b-a034-046aec3cb43c.png)

#### Efficient representation of suffix trees requires $O(n)$ space

![Suffix Tree of aba$ abaaba$ aba$ Suffix Tree](@attachment/22a93d55-d1e1-4574-86d7-aee74dfbbda2.png)
...
![5](@attachment/c8f462cf-deac-40b6-b696-18be370d433a.png)
...
- Then, path compress the tree by removing all nodes that do not have at least
  two children.
  ![Regular suffix tree](@attachment/d6d71283-bf70-445a-ae0e-b28dfb965e31.png)
...
![Before suffix extension](@attachment/6fdf29e9-29cb-43cd-9564-b9a9c8bec647.png)
...
![Before suffix extension](@attachment/13dfb3b3-15d3-40b1-9854-41c664b65200.png)
...
![Before suffix extension](@attachment/e832bcea-7c30-47a1-b7f8-12179569121b.png)
...
![rule 3](@attachment/99585795-da9e-475f-9d07-bbfe2dc7365d.png)

#### Example

![Example](@attachment/dfa1dee9-84ba-4443-a175-8ff2ce101d66.png)
...
![Example](@attachment/236d11be-c10a-43e5-9f20-599e1edc18d0.png)
...
![extension 1](@attachment/56ec5fba-f301-4dfb-8214-4808194e78e1.png)
